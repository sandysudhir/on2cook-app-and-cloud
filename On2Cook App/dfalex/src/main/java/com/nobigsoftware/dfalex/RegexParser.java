...
class RegexParser {
    ...
    private final ArrayList<DfaState<Action>> m_stateStack = new ArrayList<>();
    ...
    private char _parseCharEscape() {
        ...
        throw new RuntimeException("Invalid character escape \\" + m_src.charAt(spos));
    }
    ...
    private CharRange _parseClassEscape() {
        ...
        throw new RuntimeException("Invalid class escape \\" + m_src.charAt(spos));
    }
