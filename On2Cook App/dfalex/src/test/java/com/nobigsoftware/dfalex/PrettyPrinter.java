...
{
    private final HashMap<DfaState<?>,String> m_names = new HashMap<>();
    private final HashMap<DfaState<?>,String> m_transMemo = new HashMap<>();
    private final ArrayDeque<DfaState<?>> m_closureQ = new ArrayDeque<>();
