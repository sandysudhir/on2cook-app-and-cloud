...
//        }
        ...
        if (!formStyle.displayStepButtons) {
            nextButtonView.setVisibility(View.GONE);
        }

        if(isConfirmationStep()){
            errorContentAndButtonContainerView.setVisibility(View.GONE);
//            nextButtonView.setVisibility(View.GONE);
//            cancelButtonView.setVisibility(View.GONE);
        }else{
            errorContentAndButtonContainerView.setVisibility(View.VISIBLE);
        }
