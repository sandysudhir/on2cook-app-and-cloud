...
public final class EnglishVocabulary {
    public static Dictionary build() {
        ...
        vb.tag(THE_PREFIX,NONE)
                .e("the","this","current");
        vb.tag(PRESTEP_PREFIX, PRESTEP)
                .e("mix", "wash", "soak", "add", "cut", "pulse", "spoon", "drain", "put", "heat");
        vb.tag(PRESTEP_SEPARATOR, PRESTEP)
                .e("and", ",", "or", "the");
        vb.tag(PRESTEP_SUFFIX, PRESTEP)
                .e("scramble", "eggs","ginger", "onions", "bagel", "peppercorns", "bay leaf", "potatoes", "oil", "rice", "water", "poha", "rava", "dal", "salt", "egg", "butter", "carrots", "onion", "peas", "garlic", "sauce");
        return vb.build();
    }
}
