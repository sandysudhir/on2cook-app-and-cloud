...
class ItemStepView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private fun initView(attrs: AttributeSet?){
        View.inflate(context, R.layout.item_step_view, this)
    }
