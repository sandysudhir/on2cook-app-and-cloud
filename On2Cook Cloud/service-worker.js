const CACHE_NAME = "on2cook-cloud-v26";
const CORE_ASSETS = [
  "./",
  "./index.html",
  ...
  "./src/styles.css?v=20260615f",
  "./src/app.js?v=20260615f",
  "./src/ble-transport.js?v=20260615f",
  "./src/data-store.js?v=20260615f",
  "./src/zip-reader.js?v=20260615f",
