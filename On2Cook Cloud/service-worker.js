const CACHE_NAME = "on2cook-cloud-v102";
const CORE_ASSETS = [
  "./",
  "./index.html",
  ...
  "./src/styles.css?v=20260714h",
  "./src/app.js?v=20260714h",
  "./src/ble-transport.js?v=20260714h",
  "./src/data-store.js?v=20260714h",
  "./src/queue-logic.js?v=20260714h",
  "./src/zip-reader.js?v=20260714h",
  "./src/ncb-services.js?v=20260714h",
  "./firmware/latest/manifest.json?v=20260714h",
...
self.addEventListener("fetch", (event) => {
  ...
  if (event.request.mode === "navigate") {
    ...
    const isProStudio = requestUrl.pathname.includes("/pro-studio/");
    event.respondWith(
      fetch(event.request)
        .then((response) => {
          const clone = response.clone();
          caches.open(CACHE_NAME).then((cache) => {
            cache.put(isProStudio ? event.request : "./index.html", clone).catch(() => {});
          });
          return response;
        })
        .catch(() => (isProStudio ? caches.match(event.request) : caches.match("./index.html")))
    );
    return;
  }
  event.respondWith(
