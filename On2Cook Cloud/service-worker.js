const CACHE_NAME = "on2cook-cloud-v100";
const CORE_ASSETS = [
  "./",
  "./index.html",
  ...
  "./src/styles.css?v=20260714f",
  "./src/app.js?v=20260714f",
  "./src/ble-transport.js?v=20260714f",
  "./src/data-store.js?v=20260714f",
  "./src/queue-logic.js?v=20260714f",
  "./src/zip-reader.js?v=20260714f",
  "./src/ncb-services.js?v=20260714f",
  "./firmware/latest/manifest.json?v=20260714f",
