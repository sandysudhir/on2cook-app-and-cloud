const CACHE_NAME = "on2cook-cloud-v37";
const CORE_ASSETS = [
  "./",
  "./index.html",
  ...
  "./src/styles.css?v=20260616f",
  "./src/app.js?v=20260616f",
  "./src/ble-transport.js?v=20260616f",
  "./src/data-store.js?v=20260616f",
  "./src/zip-reader.js?v=20260616f",
